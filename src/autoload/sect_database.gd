...
func _create_hengshan():
	...
	sect.exclusive_wuxue = ["hengshan_fanji", "hengshan_wuliang", "hengshan_hengshan"]
	...
	sect.max_level = 10
	sect.exp_per_level = [0, 1000, 3000, 6000, 10000, 15000, 21000, 28000, 36000, 45000, 55000]
	
	sect.traits = ["反击流", "无限制反击", "团队守护"]
	sect.faction = "正派"
...
func _create_hengshan_talents() -> Array[CharacterTalent]:
	...
	t.max_level = 3
	t.unlock_level = 20
	t.effects = [{"type": "属性加成", "params": {"counter_chance": 0.2, "counter_dmg": 0.3}, "level_scaling": 1.0}]
	talents.append(t)
	...
	t.effects = [{"type": "特殊效果", "params": {"wuxue_range_bonus": 1, "guaranteed_counter": true}, "level_scaling": 0.0}]
	talents.append(t)
	...
	t.unlock_level = 60
	t.exclusive_sect = "恒山派"
	t.effects = [{"type": "特殊效果", "params": {"ally_shield_on_low_hp": true, "damage_share": 0.3}, "level_scaling": 0.0}]
	talents.append(t)
...
func _create_huashan():
	...
	sect.exclusive_wuxue = ["huashan_yinyang", "huashan_fengyin", "huashan_jianqi"]
	sect.wuxue_unlock_requirements = {
...
func _create_huashan_talents() -> Array[CharacterTalent]:
	...
	t.effects = [{"type": "属性加成", "params": {"yin_heal_bonus": 0.4, "yang_dmg_bonus": 0.4, "switch_cd_reduction": 1}, "level_scaling": 1.0}]
	talents.append(t)
	...
	t.unlock_level = 45
	t.exclusive_sect = "华山派"
	t.effects = [{"type": "特殊效果", "params": {"extra_skill_seal": true, "seal_duration": 2}, "level_scaling": 0.0}]
	talents.append(t)
	...
	t.unlock_level = 65
	t.exclusive_sect = "华山派"
	t.effects = [{"type": "特殊效果", "params": {"kill_qi_gain": 100, "aoe_on_kill": 0.5}, "level_scaling": 0.0}]
	talents.append(t)
...
func _create_daomo():
	...
	sect.exclusive_wuxue = ["daomo_modao", "daomo_fodao", "daomo_daofa"]
	sect.wuxue_unlock_requirements = {
...
func _create_daomo_talents() -> Array[CharacterTalent]:
	...
	t.effects = [{"type": "属性加成", "params": {"lifesteal_bonus": 0.2, "kill_heal": 0.2, "kill_rage": 30}, "level_scaling": 1.0}]
	talents.append(t)
	...
	t.unlock_level = 28
	t.exclusive_sect = "刀魔传人"
	t.effects = [{"type": "属性加成", "params": {"block_chance": 0.3, "team_shield_on_block": 0.1}, "level_scaling": 1.0}]
	talents.append(t)
	...
	t.unlock_level = 50
	t.exclusive_sect = "刀魔传人"
	t.effects = [{"type": "特殊效果", "params": {"extra_action_on_kill": true, "next_crit": true, "once_per_turn": true}, "level_scaling": 0.0}]
	talents.append(t)
...
func _create_heluo():
	...
	sect.exclusive_wuxue = ["heluo_zhaohuan", "heluo_huixue", "heluo_bangfa"]
	sect.wuxue_unlock_requirements = {
...
func _create_heluo_talents() -> Array[CharacterTalent]:
	...
	t.effects = [{"type": "属性加成", "params": {"summon_count": 2, "summon_stat_inherit": 0.2, "summon_xinfa": true}, "level_scaling": 1.0}]
	talents.append(t)
	...
	t.unlock_level = 40
	t.exclusive_sect = "河洛帮"
	t.effects = [{"type": "特殊效果", "params": {"lowest_hp_double_heal": true, "cleanse_all_debuffs": true}, "level_scaling": 0.0}]
	talents.append(t)
	...
	t.unlock_level = 55
	t.exclusive_sect = "河洛帮"
	t.effects = [{"type": "特殊效果", "params": {"summon_coop_chance": 0.3, "coop_dmg": 0.5}, "level_scaling": 0.0}]
	talents.append(t)
...
func _create_tieshi():
	...
	sect.exclusive_wuxue = ["tieshi_zhongjian", "tieshi_jianqi", "tieshi_tieshi"]
	sect.wuxue_unlock_requirements = {
...
func _create_tieshi_talents() -> Array[CharacterTalent]:
	...
	t.effects = [{"type": "属性加成", "params": {"ignore_def": 0.3, "push_wall_dmg": 2.0, "push_wall_stun": 2}, "level_scaling": 1.0}]
	talents.append(t)
	...
	t.unlock_level = 35
	t.exclusive_sect = "铁石岛"
	t.effects = [{"type": "属性加成", "params": {"neishang_chance": 0.5, "neishang_dmg": 1.0, "ignore_shield": true}, "level_scaling": 1.0}]
	talents.append(t)
	...
	t.unlock_level = 55
	t.exclusive_sect = "铁石岛"
	t.effects = [{"type": "特殊效果", "params": {"tieshi_jinshen": true, "dmg_reduction": 0.5, "cc_immune": true, "thorns": 0.3, "duration": 3, "once_per_battle": true}, "level_scaling": 0.0}]
	talents.append(t)
...
func _create_tianwu():
	...
	sect.exclusive_wuxue = ["tianwu_roushen", "tianwu_pojia", "tianwu_tianwu"]
	sect.wuxue_unlock_requirements = {
...
func _create_tianwu_talents() -> Array[CharacterTalent]:
	...
	t.unlock_level = 25
	t.exclusive_sect = "天武"
	t.effects = [{"type": "属性加成", "params": {"jinzhongzhao_chance": 0.25, "reflect_dmg": 0.5, "change_to_cd": true}, "level_scaling": 1.0}]
	talents.append(t)
	...
	t.unlock_level = 42
	t.exclusive_sect = "天武"
	t.effects = [{"type": "特殊效果", "params": {"break_shield_debuff_all": 0.2, "next_crit_after_break": true}, "level_scaling": 0.0}]
	talents.append(t)
	...
	t.unlock_level = 60
	t.exclusive_sect = "天武"
	t.effects = [{"type": "特殊效果", "params": {"hp_regen_pct": 0.1, "cheat_death_chance": 0.5, "cheat_death_duration": 1, "once_per_battle": true}, "level_scaling": 0.0}]
	talents.append(t)
...
func _create_bada():
	...
	sect.exclusive_wuxue = ["bada_huanying", "bada_kongzhi", "bada_bada"]
	sect.wuxue_unlock_requirements = {
...
func _create_bada_talents() -> Array[CharacterTalent]:
	...
	t.effects = [{"type": "属性加成", "params": {"phantom_count": 2, "phantom_stat": 0.2, "phantom_stealth": true}, "level_scaling": 1.0}]
	talents.append(t)
	...
	t.unlock_level = 40
	t.exclusive_sect = "八大门"
	t.effects = [{"type": "特殊效果", "params": {"extra_silence": 2, "qi_gain": 50, "rage_gain": 20}, "level_scaling": 0.0}]
	talents.append(t)
	...
	t.unlock_level = 55
	t.exclusive_sect = "八大门"
	t.effects = [{"type": "特殊效果", "params": {"mizong_immunity": 3, "dodge_bonus": 0.5}, "level_scaling": 0.0}]
	talents.append(t)
...
func _create_nanshan():
	...
	sect.exclusive_wuxue = ["nanshan_longquan", "nanshan_yibo", "nanshan_nanshan"]
	sect.wuxue_unlock_requirements = {
...
func _create_nanshan_talents() -> Array[CharacterTalent]:
	...
	t.effects = [{"type": "属性加成", "params": {"longquan_true_dmg": 0.2, "longwei_atk": 0.3, "longwei_crit_dmg": 0.5, "longwei_duration": 3}, "level_scaling": 1.0}]
	talents.append(t)
	...
	t.unlock_level = 45
	t.exclusive_sect = "南山派"
	t.effects = [{"type": "特殊效果", "params": {"early_crit_bonus": 0.5, "early_crit_dmg": 0.5, "decay_per_turn": 0.1, "kill_restore": true}, "level_scaling": 0.0}]
	talents.append(t)
	...
	t.unlock_level = 60
	t.exclusive_sect = "南山派"
	t.effects = [{"type": "特殊效果", "params": {"hp_threshold": 0.8, "basic_becomes_longquan": true, "aoe": "菱形2", "dmg_mult": 2.0, "guaranteed_crit": true}, "level_scaling": 0.0}]
	talents.append(t)
...
func _create_buqi():
	...
	sect.exclusive_wuxue = ["buqi_jiguan", "buqi_dilei", "buqi_dushu"]
	sect.wuxue_unlock_requirements = {
...
func _create_buqi_talents() -> Array[CharacterTalent]:
	...
	t.effects = [{"type": "属性加成", "params": {"trap_spread": 2, "trap_invisible": true, "trap_dmg_bonus": 0.5}, "level_scaling": 1.0}]
	talents.append(t)
	...
	t.unlock_level = 40
	t.exclusive_sect = "不器门"
	t.effects = [{"type": "特殊效果", "params": {"poison_true_dmg": true, "mp_loss_pct": 0.05, "unlimited_stacks": true}, "level_scaling": 0.0}]
	talents.append(t)
	...
	t.unlock_level = 55
	t.exclusive_sect = "不器门"
	t.effects = [{"type": "特殊效果", "params": {"death_trap": true, "delay": 3, "dmg_pct": 0.5, "poison_spread": 3, "once_per_battle": true}, "level_scaling": 0.0}]
	talents.append(t)
...
func get_all_sects() -> Array[SectData]:
	return sect_list.values()

func get_sects_by_faction(faction: String) -> Array[SectData]:
	return sect_by_faction.get(faction, [])
