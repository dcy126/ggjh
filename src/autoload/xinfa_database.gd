...
func _create_attack_xinfa():
	...
	x.tags = ["速度", "先手", "闪避"] as Array[String]
...
func _create_defense_xinfa():
	...
	x.tags = ["化劲", "反震", "护盾"] as Array[String]
	...
	x.tags = ["格挡", "反击", "主角专属"] as Array[String]
	...
	x.tags = ["援护", "分担", "队友"] as Array[String]
	...
	x.tags = ["基础", "血量", "防御"] as Array[String]
...
func _create_support_xinfa():
	...
	x.tags = ["治疗", "护盾", "回蓝"] as Array[String]
	...
	x.tags = ["集气", "怒气", "缩减CD"] as Array[String]
	...
	x.tags = ["净化", "免疫控制", "福缘"] as Array[String]
	...
	x.tags = ["护盾", "援护", "团队"] as Array[String]
	...
	x.tags = ["基础", "血量", "内力"] as Array[String]
...
func _create_special_xinfa():
	...
	x.tags = ["集气", "连击", "追击", "集气流"] as Array[String]
	...
	x.tags = ["低血高伤", "嗜血", "修罗"] as Array[String]
	...
	x.tags = ["先手", "反击", "反手"] as Array[String]
	...
	x.tags = ["回蓝", "自愈", "复活"] as Array[String]
	...
	x.tags = ["迷离", "混乱", "闪避"] as Array[String]
...
func _create_xinfa_sets():
	...
	set.name = "奋战套装"
	set.piece_ids = ["fen_zhan", "qiang_bi", "zhuang_gu", "wan_neng"] as Array[String]
	set.effects = {
	...
	set.name = "化劲套装"
	set.piece_ids = ["hua_jin", "zheng_feng", "gui_shou", "wan_neng"] as Array[String]
	set.effects = {
