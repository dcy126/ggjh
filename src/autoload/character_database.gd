...
func _create_sample_characters():
	...
	mc.known_wuxue = ["草头风云录"] as Array[String]
	mc.equipped_wuxue = ["草头风云录"] as Array[String]
	mc.xinfa_slots = 7
	...
	xin.known_wuxue = ["楚狂剑法", "破阵子", "满江红"] as Array[String]
	xin.equipped_wuxue = ["楚狂剑法"] as Array[String]
	xin.xinfa_slots = 7
	...
	liu.known_wuxue = ["蝶恋花剑法", "化蝶", "花影重重"] as Array[String]
	liu.equipped_wuxue = ["蝶恋花剑法"] as Array[String]
	liu.xinfa_slots = 7
	...
	nalan.known_wuxue = ["长白剑法", "朔雪挡刀", "恒山剑气"] as Array[String]
	nalan.equipped_wuxue = ["长白剑法"] as Array[String]
	nalan.xinfa_slots = 7
	...
	ye.known_wuxue = ["沧海月明", "护佑苍生", "月下独酌"] as Array[String]
	ye.equipped_wuxue = ["沧海月明"] as Array[String]
	ye.xinfa_slots = 7
	...
	li.known_wuxue = ["莫失莫忘", "大师姐威严", "琴剑双绝"] as Array[String]
	li.equipped_wuxue = ["莫失莫忘"] as Array[String]
	li.xinfa_slots = 7
	...
	hua.known_wuxue = ["慈悲相", "忿怒相", "八风不动"] as Array[String]
	hua.equipped_wuxue = ["慈悲相"] as Array[String]
	hua.xinfa_slots = 7
	...
	tang.known_wuxue = ["三生愿", "为我而生", "桃花誓"] as Array[String]
	tang.equipped_wuxue = ["三生愿"] as Array[String]
	tang.xinfa_slots = 7
	...
	lu.known_wuxue = ["东灵剑气", "剑气纵横", "陆游诗剑"] as Array[String]
	lu.equipped_wuxue = ["东灵剑气"] as Array[String]
	lu.xinfa_slots = 7
	...
	wang.known_wuxue = ["空谷幽兰", "诗画江湖", "摩诘无我"] as Array[String]
	wang.equipped_wuxue = ["空谷幽兰"] as Array[String]
	wang.xinfa_slots = 7
	...
	li_x.known_wuxue = ["桃花扇", "空山凝云", "血溅桃花"] as Array[String]
	li_x.equipped_wuxue = ["桃花扇"] as Array[String]
	li_x.xinfa_slots = 7
	...
	cui.known_wuxue = ["云淡风轻", "机关百变", "毒术折磨"] as Array[String]
	cui.equipped_wuxue = ["云淡风轻"] as Array[String]
	cui.xinfa_slots = 7
	...
	qu.known_wuxue = ["蔷薇之心", "群体治疗", "集气怒气"] as Array[String]
	qu.equipped_wuxue = ["蔷薇之心"] as Array[String]
	qu.xinfa_slots = 7
